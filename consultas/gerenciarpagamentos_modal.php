...
<div class="modal" id="gerenciarpagamentomodal" tabindex="-1" aria-labelledby="gerenciarpagamentomodalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header mb-0 pb-0">      
                <div class="col align-self-start pl-0">
                    ...
                    <div class="col-md">
                        <h7 class="modal-title" id="textoGPsituacao"></h7>
                    </div>
                </div>
            ...
            <div class="modal-body pt-0">
                <div class="table mt-2 ts-divTabela60 ts-tableFiltros text-center">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody id='dados_gerenciarPagamento' class="fonteCorpo">
