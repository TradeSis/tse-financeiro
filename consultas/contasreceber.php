...
<body>
    <div class="container-fluid">
        ...
        <div class="row d-flex align-items-center justify-content-center mt-1 pt-1 ">
            ...
            <div class="col-11 col-lg-5 order-lg-5">
                <div class="input-group">
                    <input type="text" class="form-control ts-input" id="buscaContasReceber" placeholder="Buscar por historico">
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <form method="post" id="inserirFormContasReceber">
                            <div class="row">
                                <div class="col-md">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="col align-self-start pl-0">
                            <div class="col-md">
                                <h5 class="modal-title">Alterar Conta à Receber</h5>
                            </div>
                            <div class="col-md">
                    ...
                    <div class="modal-body pt-0">
                        <form method="post" id="alterarFormContasReceber">
                            <div class="row">
        ...
        <!--------- BAIXAR PAGAMENTO --------->
        <div class="modal" id="baixarrecebimentomodal" tabindex="-1" aria-labelledby="baixarrecebimentomodalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body pt-0">
                        <form method="post" id="inserirFormCrPagamento">
                            <div class="row mt-2">
                                <div class="col-md">
                                    <label class="form-label ts-label">Historico</label>
                                    <input type="text" class="form-control ts-input" name="historico" id="bp_historico">
                                    <input type="hidden" class="form-control ts-input" name="idCR" id="bp_idCR">
                                </div>
                                <div class="col-md-3">
        ...
        <!--------- EXCLUIR CONTAS RECEBER --------->
        <div class="modal fade" id="excluirContasRecebermodal" tabindex="-1" aria-labelledby="excluirContasRecebermodalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0 mb-0 pb-0">
                        <div class="alert alert-warning d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Deseja Realmente excluir esse Recebimento?
                            </div>
                        </div>
                        <form method="post" id="excluirFormContasPagar">
                            <div class="row mt-2 d-none">
                                <div class="col-md">
                                    ...
                                    <input type="text" class="form-control ts-input" name="idCR" id="excluirContasPagar_idCR" readonly>
                                </div>
                            </div>
                    </div><!--body-->
        ...
        <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body mt-0 pt-0">
                <form method="post" id="inserirFormContasReceberClonar">
                    <div class="row">
                        <div class="col-md">
    ...
    <script>
        buscar($("#buscaContasReceber").val(), $("#FiltroCategoria").val(), $("#FiltroPortador").val(), $("#FiltroSituacao").val(), $("#FiltroPeriodoInicio").val(), $("#FiltroPeriodoFim").val());
        ...
        function buscar(buscaContasReceber, idCategoria, idPortador, filtrosituacao, PeriodoInicio, PeriodoFim) {
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    for (var $i = 0; $i < json.length; $i++) {
                        ...
                        linha += "<td class='ts-click' data-idCR='" + object.idCR + "'>" + dataCompetenciaFormatada + "</td>";
                        ...
                        linha += "<td class='ts-click' data-idCR='" + object.idCR + "'>" + dataVencimentoFormatada + "</td>";
                        linha += "<td class='ts-click' data-idCR='" + object.idCR + "'>" + dataLiquidacaoFormatada + "</td>";
                        linha += "<td class='ts-click' data-idCR='" + object.idCR + "'>" + (vValor !== null ? vValor.toLocaleString('pt-br', {
                            minimumFractionDigits: 2
                        }) : "-") + "</td>";
                        linha += "<td class='text-start ts-click' data-idCR='" + object.idCR + "'>" + object.situacao + "</td>";
                        linha += "<td>";
                        ...
                        linha += "<li class='ms-1 me-1 mt-1'><a class='btn btn-primary btn-sm w-100 text-start' data-toggle='modal' data-target='#baixarrecebimentomodal' data-idCR='" + object.idCR + "' role='button'><i class='bi bi-check-lg'></i> Baixar</a></li>";
                        linha += "<li class='ms-1 me-1 mt-1'><button class='btn btn-primary btn-sm w-100 text-start clonarButton' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' data-idCR='" + object.idCR + "'><i class='bi bi-copy'></i> Clonar</button></li>"
                        if (object.situacao != 'Aberto') {
                            linha += "<li class='ms-1 me-1 mt-1'><a class='btn btn-primary btn-sm w-100 text-start' data-toggle='modal' data-target='#gerenciarrecebimentomodal' data-idCR='" + object.idCR + "' role='button'><i class='bi bi-clipboard-pulse'></i> Gerenciar</a></li>";
                        }
                        linha += "<li ><hr class='mt-2 mb-1'></li>";
                        if (object.situacao != 'Parcial') {
                            linha += "<li class='ms-1 me-1 mt-1'><a class='btn btn-danger btn-sm w-100 text-start' data-toggle='modal' data-target='#excluirContasRecebermodal' data-idCR='" + object.idCR + "' role='button'><i class='bi bi-trash3'></i> Excluir</a></li>";
                        }
                        linha += "</tr></ul></div>"
                        linha += "</td>";
        ...
        $("#buscar").click(function() {
            buscar($("#buscaContasReceber").val(), $("#FiltroCategoria").val(), $("#FiltroPortador").val(), $("#FiltroSituacao").val(), null, null);
        });
        ...
        $("#FiltroCategoria").change(function() {
            ...
            if (vfiltrosituacao != "emaberto") {
                buscar($("#buscaContasReceber").val(), $("#FiltroCategoria").val(), $("#FiltroPortador").val(), $("#FiltroSituacao").val(), datainiciomes, dataatualmes);
            } else {
                buscar($("#buscaContasReceber").val(), $("#FiltroCategoria").val(), $("#FiltroPortador").val(), $("#FiltroSituacao").val(), null, null);
            }
        });
        ...
        $(document).on('click', 'a[data-target="#baixarrecebimentomodal"]', function() {
            var idCR = $(this).attr("data-idCR");
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#baixarrecebimentomodal').modal('show');
                }
            });
        });

        //MODAL GERENCIAR RECEBIMENTO
        $(document).on('click', 'a[data-target="#gerenciarrecebimentomodal"]', function() {
            var idCR = $(this).attr("data-idCR");
        ...
        $(document).on('click', 'a[data-target="#excluirContasRecebermodal"]', function() {
            var idCR = $(this).attr("data-idCR");

            $('#excluirContasPagar_idCR').val(idCR);

            $('#excluirContasRecebermodal').modal('show');
        });
        ...
        $(document).on('click', 'button.clonarButton', function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '../database/contasreceber.php?operacao=buscar',
                data: {
                    idCR: idCR
                },
                success: function(data) {
    ...
    <script>
        $(document).ready(function() {
            $("#inserirFormContasReceber").submit(function(event) {
            ...
            $("#inserirFormContasReceberClonar").submit(function(event) {
                event.preventDefault();
                var formData = new FormData(this);
                $.ajax({
                    url: "../database/contasreceber.php?operacao=inserir",
            ...
            $("#alterarFormContasReceber").submit(function(event) {
                event.preventDefault();
                var formData = new FormData(this);
                $.ajax({
            ...
            $("#inserirFormCrPagamento").submit(function(event) {
                event.preventDefault();
                var formData = new FormData(this);
                $.ajax({
                    url: "../database/contasreceberpagamento.php?operacao=inserir",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#excluirFormContasPagar").submit(function(event) {
                ...
                var formData = new FormData(this);
                $.ajax({
                    url: "../database/contasreceber.php?operacao=excluir",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
