    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex align-items-center justify-content-center mt-1 pt-1 ">
            ...
            <div class="col-4 col-lg-3 order-lg-2" id="filtroh6">
                <h2 class="ts-tituloPrincipal">Contas Ã  Receber</h2>
        ...
        <script>
            ...
            function buscar(buscaContasReceber, idCategoria, idPortador, filtrosituacao, PeriodoInicio, PeriodoFim) {
                ...
                if (PeriodoFim !== "") {
                    text += PeriodoFim !== null ? " atÃ© " + formatDate(PeriodoFim) : " ";
                }
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        for (var $i = 0; $i < json.length; $i++) {
                            ...
                            linha += "<td>";
                            linha += "<div class='btn-group dropstart'><button type='button' class='btn' data-toggle='tooltip' data-placement='left' title='OpÃ§Ãµes' data-bs-toggle='dropdown' " +
                                " aria-expanded='false' style='box-shadow:none'><i class='bi bi-three-dots-vertical'></i></button><ul class='dropdown-menu'>";

                            linha += "<li class='ms-1 me-1 mt-1'><a class='btn btn-primary btn-sm w-100 text-start' data-toggle='modal' data-target='#baixarrecebimentomodal' data-idCR='" + object.idCR + "' role='button'><i class='bi bi-pencil-square'></i> Baixar</a></li>";
                            if (object.situacao != 'Aberto') {
                                linha += "<li class='ms-1 me-1 mt-1'><a class='btn btn-primary btn-sm w-100 text-start' data-toggle='modal' data-target='#gerenciarrecebimentomodal' data-idCR='" + object.idCR + "' role='button'><i class='bi bi-pencil-square'></i> Gerenciar</a></li>";
                            }
