...
if (isset($LOG_CAMINHO)) {
  ...
  $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "contasreceberpagamento_inserir";
  if (isset($LOG_NIVEL)) {
    if ($LOG_NIVEL >= 1) {
...
//LOG
  ...
  $retorno = $progr->executarprogress("financeiro/app/1/contasreceberpagamento_inserir", json_encode($jsonEntrada));
