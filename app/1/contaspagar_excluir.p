...
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "contaspagar nao deletado".
...
do on error undo:
    find contaspagar where contaspagar.idCP = ttentrada.idCP.
    DELETE contaspagar. 
end.
...
create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "contaspagar deletado com sucesso".
