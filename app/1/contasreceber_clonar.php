...
if (isset($LOG_CAMINHO)) {
    ...
    $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "contasreceber_clonar";
    if (isset($LOG_NIVEL)) {
        if ($LOG_NIVEL >= 1) {
...
if (isset($jsonEntrada['idPessoaFornecedor'])) {
    ...
    try {
        ...
        $retorno = $progr->executarprogress("financeiro/app/1/contasreceber_clonar",json_encode($jsonEntrada));
