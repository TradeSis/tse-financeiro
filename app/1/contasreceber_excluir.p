...
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "contasreceber nao deletado".
...
do on error undo:
    find contasreceber where contasreceber.idCR = ttentrada.idCR.
...
create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "contasreceber deletado com sucesso".
