...
if not avail contaspagarpagamento
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "contaspagarpagamento nao deletado".
...
do on error undo:
    find contaspagarpagamento where contaspagarpagamento.idCpPgto = ttentrada.idCpPgto.
    DELETE contaspagarpagamento. 
end.
...
create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "contaspagarpagamento deletado com sucesso".
