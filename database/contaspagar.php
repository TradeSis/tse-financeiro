...
if (isset($_GET['operacao'])) {
	...
	if ($operacao == "inserir") {
		...
		$valorOriginal_formatado = str_replace(',', '.', $valorOriginal_formatado); // troca a v�rgula por ponto
	...
	if ($operacao == "excluir") {
		...
		$contas = chamaAPI(null, '/financeiro/contaspagar', json_encode($apiEntrada), 'DELETE');
	}
